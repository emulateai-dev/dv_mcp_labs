...
# supplied at runtime through DVMCP_CHALLENGE7_* environment variables; when
# none are set, clearly-marked non-functional placeholder values are used so
# the demo still boots without leaking secrets in source control.
TOKEN_FILE = "/tmp/dvmcp_challenge7/tokens.json"
if not os.path.exists(TOKEN_FILE):
    with open(TOKEN_FILE, "w") as f:
        json.dump(_get_runtime_tokens(), f, indent=2)
