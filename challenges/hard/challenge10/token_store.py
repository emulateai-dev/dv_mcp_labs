...
The challenge server (and any boot scripts) materialize a ``tokens.json`` file
for the demo and hand a token to the ``authenticate`` tool. Historically these
tokens were hardcoded JWTs checked into source control (CWE-798 / CWE-312),
...
# obviously-fake label and make it clear at a glance they are demo values.
